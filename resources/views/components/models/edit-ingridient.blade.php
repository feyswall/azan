<div class="modal fade" id="editIngridientModel-{{$ingr}}" tabindex="-1" role="dialog"
     aria-labelledby="editIngridientModalLabel-{{$ingr}}"
     aria-hidden="true">
    <div id="model-dialogue" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="edit-ing-model" class="modal-body">
                <!-- component -->
                <div class="p-3">
                    <form id="editIngridientForm-{{$ingr}}">
                        <div class="form-group">
                            <label for="ingridient_name">{{ $ingr }}<span></span></label>
